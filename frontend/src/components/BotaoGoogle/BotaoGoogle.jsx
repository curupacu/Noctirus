...
// Ícone oficial do "G" colorido do Google — reaproveitado nos dois pontos de entrada
// (login e cadastro), que fazem a mesma chamada (loginComGoogle) e só decidem depois pra
// onde mandar o usuário (ver LoginPage e CadastroPage).
export function BotaoGoogle({ children, ...props }) {
  return (
    <Button type="button" variant="light" {...props}>
      <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true">
        ...
        <path
          fill="#34A853"
          d="M9 18c2.43 0 4.47-.81 5.96-2.18l-2.92-2.26c-.81.54-1.84.86-3.04.86-2.34 0-4.32-1.58-5.03-3.7H.95v2.33A9 9 0 0 0 9 18Z"
        />
        <path
          fill="#FBBC05"
